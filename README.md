...
[![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](http://godoc.org/github.com/navono/go-sqlcipher) [![CI](https://github.com/navono/go-sqlcipher/workflows/CI/badge.svg)](https://github.com/navono/go-sqlcipher/actions)
...
To upgrade your Go code to the 4.x series, change the import path to
    ...
    "github.com/navono/go-sqlcipher/v4"

### Installation

This package can be installed with the go get command:

    go get github.com/navono/go-sqlcipher
...
http://godoc.org/github.com/navono/go-sqlcipher

Use the function
[sqlite3.IsEncrypted()](https://godoc.org/github.com/navono/go-sqlcipher#IsEncrypted)
